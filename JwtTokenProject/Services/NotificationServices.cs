...
namespace JwtTokenProject.Services
{
    ...
    public class NotificationServices : INotificationServices
    {
        ...
        public async Task SendWelcomeEmailAsync(string toEmail, string userName)
        {
            ...
            {
                Port = 587,
                Credentials = new NetworkCredential("yourmail", "password"),// google çift doğrulama ve uygulama şifresi ile giriş yap
                EnableSsl = true,
            };
            var mail = new MailMessage("yourmail", toEmail) //mailMessage sınıfı mail nesnesi
            {
